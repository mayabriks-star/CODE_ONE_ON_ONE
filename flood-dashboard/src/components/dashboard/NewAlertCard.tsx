...
export default function NewAlertCard({ onClick }: Props) {
  return (
    <div
      onClick={onClick}
      className="absolute left-[21px] top-[620px] w-[326px] rounded-lg cursor-pointer alert-card-enter hover:opacity-90 transition-opacity"
      ...
      <div className="flex items-center justify-between px-[14px] py-[12px] gap-[12px]">
        <div className="flex flex-col gap-[4px] flex-1">
          ...
          <p className="text-[11px] leading-[16px] text-[rgba(255,255,255,0.85)]">
            Sea level has reached a level that requires immediate action. Review risk areas before impact occurs.
          </p>
        </div>
