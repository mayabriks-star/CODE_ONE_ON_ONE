...
export default function ResidentialEdgePage({ onBack, onApprove, embedded }: Props) {
      ...
      >
        ...
        <div className="no-scrollbar" style={{ width: '724px', flexShrink: 0, overflowY: 'auto', paddingBottom: '35px' }}>
          ...
          <div style={{ position: 'relative' }}>
            <img
              src="/elevated-buildings-tab.png"
              alt="Residential edge blocks aerial view"
              style={{ width: '100%', height: '341px', objectFit: 'cover', objectPosition: 'center 40%', borderRadius: '20px 20px 0 0', display: 'block' }}
            />
