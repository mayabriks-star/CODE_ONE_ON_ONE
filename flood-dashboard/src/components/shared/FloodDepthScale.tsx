export default function FloodDepthScale() {
  return (
    <div className="absolute left-[21px] top-[25px] w-[326px] h-[65px] glass-30 glass-shadow-sm rounded-lg px-[9px] py-[4px] flex flex-col gap-[4px]">
